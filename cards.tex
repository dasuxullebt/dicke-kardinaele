...
{\bf Satz 9:} Seien $\kappa\le\lambda$.
	...
	{\bf Beweis:} (1)$\to$(2): Sei $j\colon V\to M$ wie in Def. von ``$\kappa$ ist $\lambda$-superkompakt''.
		...
		%Aber $j(Z)=\{a\in j(\mathcal P_{\kappa}(\lambda))$ %### 1Zeile
...
% Sivic: übersetzung unbeweisbarer aussagen in diophantische gleichungen?

% Schlussbemerkungen
% \begin{itemize}
%		\item Große Kardinalzahlen sind natürlich, da bereits 'einfache' kombinatorische Fragestellungen (auch schon im unteren Bereich der Mengenhierarchie) zu großen Kardinalzahlen führen bsp.: $\neg\Box_{\omega_1}\to \omega_2$ ist Mahlo in $L$
%
%			Wenn $\ZFC + \exists\kappa (\kappa \mbox{ ist Mahlo})$ konsistent, so ist auch $\ZFC+\neg\Box_{\omega_1}$ konsistent (Stärkere Aussagen lassen sich hierzu überhaupt nicht zeigen)
%		\item Große Kardinalzahlen beantworten eine Fragen der klassischen Analysis (insb. \emph{deskriptive Mengenlehre}. (Untersuchung ''definierbarer'' Teilmengen der reellen Zahlen, z.b. projektive Mengen = stetiger Abschluss der Borel-Mengen unter Bildern und Komplementen)
%
%			Bekanntes Resultat: Mittels Großer Kardinalzahlen (etwa Woodin) lässt sich zeigen, dass alle projektiven Mengen Lebesque-messbar sind. Dies lässt sich NUR mittels großer Kardinalzahlen zeigen (Konsistenz der Aussage folgt aus $\exists\kappa \kappa \mbox{unerreichbar}$, Implikation $\exists\kappa \kappa\mbox{ woodin}$.)
%	\end{itemize}
